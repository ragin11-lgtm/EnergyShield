...
The local command binds the lab to `127.0.0.1` so it is available only on the local computer. The V1 dashboard has no authentication and should not be exposed directly from a personal computer.
